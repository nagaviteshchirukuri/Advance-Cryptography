    ...
    def encode_image(self, img, msg):
        ...
        for row in range(height):
            for col in range(width):
                ...
                if img.mode == 'RGB':
                    r, g, b = pixel
                    a = 255  # Set alpha to 255 for RGB images
                elif img.mode == 'RGBA':
                    r, g, b, a = pixel
                else:
                ...
                # First value is the length of the msg
                if row == 0 and col == 0 and index < length:
                    ...
                    asc = b
                encoded.putpixel((col, row), (r, g, asc, a))
                index += 1
        return encoded
...
image2 = Image.open("DRM.png")
image1 = LSB().encode_image(image2,seller1.fingerprint)
image1.save("DRM.png")
blockchain.add_new_transaction("DRM.png",seller1,buyer1)
